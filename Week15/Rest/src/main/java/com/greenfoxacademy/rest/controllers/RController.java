...
//    public @ResponseBody
//    String handleInputException(MissingServletRequestParameterException e) {
//        InputData inputData = new InputData();
//        inputData.setError("Please provide an input!");
//        return inputData.getError();
//    }
    ...
    public Dountil doUntil(@PathVariable(value = "what") String what,
                           @RequestBody Until until) { //using requestbody so that it can return with an object
